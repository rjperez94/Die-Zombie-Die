...
public class PlayerTests {
	...
	public void testMoveToSouth() throws NoSuchFieldException,
		...
		for (int i = 0; i < 3; i++) {
            ...
            assertEquals(p.getX(), xBefore, 0.0);
			assertTrue(p.getY() > yBefore);
            assertSame(Direction.SOUTH, p.isFacing());
		}
	}
	...
	public void testMoveToNorth() throws NoSuchFieldException,
		...
		for (int i = 0; i < 3; i++) {
            ...
            assertEquals(p.getX(), xBefore, 0.0);
			assertTrue(p.getY() < yBefore);
            assertSame(Direction.NORTH, p.isFacing());
		}
	}
	...
	public void testMoveToEast() throws NoSuchFieldException,
		...
		for (int i = 0; i < 3; i++) {
            ...
            assertEquals(p.getY(), yBefore, 0.0);
            assertSame(Direction.EAST, p.isFacing());
		}
	}
	...
	public void testMoveToWest() throws NoSuchFieldException,
		...
		for (int i = 0; i < 3; i++) {
			...
			assertTrue(p.getX() < xBefore);
			assertEquals(p.getY(), yBefore, 0.0);
			assertSame(Direction.WEST, p.isFacing());
		}
	}
